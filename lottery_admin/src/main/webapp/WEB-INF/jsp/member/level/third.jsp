            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="system/memberLevel/thirdSubmit">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">第三方支付：</label>
                                        <div class="col-sm-5">
                                        	<select class="form-control" name="third">
                                        	<option value="" label="">
                                   			<c:forEach var="third" items="${data.expand.thirdList}">
                                   			<option value="${third.id}" label="${third.name}" ${third.checked==1?"selected":""}>
                                            </c:forEach>
                                            </select>
                                   		</div>
                                        <div class="col-sm-5 form-control-static"></div>
