            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="system/memberLevel/bankSubmit">
                                        ...
                                        <div class="col-sm-5">
                                   			<c:forEach var="bank" items="${data.expand.bankList}">
                                    			<label class="checkbox-inline">
                                                	<input name="bank" type="checkbox" ${bank.checked==1?"checked":""} value="${bank.id}">${bank.bank_name}: ${bank.account_name}(${bank.account_code})
                                                </label>
                                                <br>
                                            </c:forEach>
                                   		</div>
