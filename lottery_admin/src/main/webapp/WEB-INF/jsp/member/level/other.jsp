            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="system/memberLevel/otherSubmit">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5" style="margin-top: 5px;">
                                        	<c:forEach var="other" items="${data.expand.otherList}">
                                   			<input type="checkbox" name="third" value="${other.id}" ${other.checked==1?"checked":""}>${other.name}<br>
                                            </c:forEach>
                                   		</div>
                                        <div class="col-sm-5 form-control-static"></div>
                                    </div>
