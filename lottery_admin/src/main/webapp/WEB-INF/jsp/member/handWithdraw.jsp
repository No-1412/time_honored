            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="system/member/handWithdrawSubmit">
                                	<input name="memberId" value="${data.id}" type="text" style="display:none;">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">账号：</label>
                                        <div class="col-sm-5">
                                            <input ${data.id != null?"readonly":""} cls="{required:true}" name="memberCode" type="text" class="form-control" value="${data.code}">
                                        </div>
