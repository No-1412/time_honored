            ...
            <div class="col-sm-12">
            	...
            	<table class="table table-bordered table-condensed">
					...
					<tbody>
		           		<tr>
		           			<td>红波</td>
		           			<td><input class="quickNumber" type="number" min="0" name="n13101" value="${data.n13101.bonus}"></td>
		           			<td>蓝波</td>
		           			<td><input class="quickNumber" type="number" min="0" name="n13102" value="${data.n13102.bonus}"></td>
		           			<td>绿波</td>
		           			<td><input class="quickNumber" type="number" min="0" name="n13103" value="${data.n13103.bonus}"></td>
		           			<td>和局</td>
		           			<td><input class="quickNumber" type="number" min="0" name="n13104" value="${data.n13104.bonus}"></td>
		               	</tr>
	            	</tbody>
            	</table>
