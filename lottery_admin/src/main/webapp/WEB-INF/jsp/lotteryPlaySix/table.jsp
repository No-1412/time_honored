                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <table class="table table-bordered table-condensed">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                ...
                                                <a class="btn btn-sm btn-primary custom_submit_link" data-id="${data.lotteryType}" data-msg="确定要更新缓存？" data-url="system/lotteryPlaySix/updateCache" href="">更新缓存</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <tbody id="tableId" url="system/lotteryPlaySix/getList">
								 <tr>
