                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered table-condensed">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="input-group">
	                                            <input type="button" value="添加" class="btn btn-sm btn-primary add_link" data-url="system/scrollImg/edit"></span>
		                                     	&nbsp;
                            ...
                            <thead>
                                <tr>
                                    <th width="50">ID</th>
                                    <th width="150">PC图片</th>
                                    <th width="150">WAP图片</th>
                                    <th width="80">是否显示</th>
                            ...
                            <tbody id="tableId" url="system/scrollImg/getList">
								 <tr>
