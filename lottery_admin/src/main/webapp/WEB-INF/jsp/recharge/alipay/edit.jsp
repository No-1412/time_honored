            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="system/alipay/editSubmit">
                                    ...
                                    <div id="alipay_code"  class="form-group">
                                        <label id="lbl_code" class="col-sm-2 control-label">支付宝账号：</label>
                                        <div class="col-sm-5">
                                            <input cls="{required:true}" type="text" name="code" class="form-control" value="${data.code}">
                                        </div>
                                        <div class="col-sm-5 form-control-static"></div>
                                    </div>
                                    <div id="alipay_name" class="form-group">
                                        <label id="lbl_name" class="col-sm-2 control-label">支付宝名称：</label>
                                        <div class="col-sm-5">
                                            <input cls="{required:true}" type="text" name="name" class="form-control" value="${data.name}">
                                        </div>
                                        <div class="col-sm-5 form-control-static"></div>
                                    </div>
                                    <div id="alipay_bank" class="form-group" style="display: none;">
    ...
    <script type="text/javascript">
	    requirejs(["jquery","form","uploader","UMeditor","um.zh"],function($,form,uploader,UM){
	        ...
	        $('#type_scan').on('click', function(){
	    	   $('#alipay_code').css('display', 'block');
	    	   $('#alipay_name').css('display', 'block');
	    	   $('#min_amount').css('display', 'block');
	    	   $('#max_amount').css('display', 'block');
	    	   $('#pay_desc').css('display', 'block');
	    	   
	    	   $('#alipay_bank').css('display', 'none');
	       });
	       ...
	       $('#type_transfer').on('click', function(){
	    	   $('#alipay_code').css('display', 'none');
	    	   $('#alipay_name').css('display', 'none');
	    	   $('#min_amount').css('display', 'block');
	    	   $('#max_amount').css('display', 'block');
	    	   $('#pay_desc').css('display', 'block');
	    	   
	    	   $('#alipay_bank').css('display', 'block');
	       });
		   ...
		   if(($('#type_scan').attr("checked"))) {
	    	   ...
	    	   $('#min_amount').css('display', 'block');
	    	   $('#max_amount').css('display', 'block');
		   } else if($('#type_transfer').attr("checked")){
	    	   $('#alipay_code').css('display', 'none');
	    	   $('#alipay_name').css('display', 'none');
	    	   $('#min_amount').css('display', 'block');
	    	   $('#max_amount').css('display', 'block');
