...
<c:if test="${data != null && data.items != null}">
	<c:forEach var="third" items="${data.items}">
	    <tr>
	        ...
	        <td>
	         	<a class="btn btn-sm btn-info edit_link" data-id="${third.id}" data-url="system/withdrawThird/edit" href="">编辑</a>
	         	<a class="btn btn-sm btn-danger cancel_link" data-id="${third.id}" data-url="system/withdrawThird/delete" href="#">删除</a>
	        </td>
	    </tr>
    </c:forEach>
</c:if>
