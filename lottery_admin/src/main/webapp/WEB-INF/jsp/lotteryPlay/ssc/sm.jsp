        ...
        <div class="row clearfix">
            <div class="col-sm-12">
            	...
            	<table class="table table-bordered table-condensed">
					...
					<tbody>
		           		<tr>
		           			<td><input type="number" min="0" name="n60" value="${data.n60.bonus}"></td>
		           			<td><input type="number" min="0" name="n61" value="${data.n61.bonus}"></td>
			               	<td><input type="number" min="0" name="n62" value="${data.n62.bonus}"></td>
			               	<td><input type="number" min="0" name="n63" value="${data.n63.bonus}"></td>
			               	<td><input type="number" min="0" name="n64" value="${data.n64.bonus}"></td>
			               	<td><input type="number" min="0" name="n65" value="${data.n65.bonus}"></td>
			               	<td><input type="number" min="0" name="n66" value="${data.n66.bonus}"></td>
		               	</tr>
	            	</tbody>
            	</table>
