        ...
        <div class="row clearfix">
            <div class="col-sm-12">
	        	...
	        	<table class="table table-bordered table-condensed">
					...
					<tbody>
		           		<tr>
			               	<td><span class="ball b1"></span><span class="ball b1"></span><span class="ball b1"></span></td>
			               	<td><input class="quickNumber" type="number" min="0" name="n1" value="${data.n1.bonus}"></td>
			               	<td><span class="ball b2"></span><span class="ball b2"></span><span class="ball b2"></span></td>
			               	<td><input class="quickNumber" type="number" min="0" name="n2" value="${data.n2.bonus}"></td>
			               	<td><span class="ball b3"></span><span class="ball b3"></span><span class="ball b3"></span></td>
		               	...
		               	<tr>
		               		<td><span class="ball b4"></span><span class="ball b4"></span><span class="ball b4"></span></td>
			               	<td><input class="quickNumber" type="number" min="0" name="n4" value="${data.n4.bonus}"></td>
			               	<td><span class="ball b5"></span><span class="ball b5"></span><span class="ball b5"></span></td>
			               	<td><input class="quickNumber" type="number" min="0" name="n5" value="${data.n5.bonus}"></td>
			               	<td><span class="ball b6"></span><span class="ball b6"></span><span class="ball b6"></span></td>
