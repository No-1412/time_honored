                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <table class="table table-bordered table-condensed">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                <input type="button" value="添加" class="btn btn-sm btn-primary add_link" data-width="370px" data-height="400px" data-url="system/access/edit"></span>
                            ...
                            <tbody id="tableId" url="system/access/getList">
								 <tr>
