            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="yitong/editSubmit">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">下发类型：</label>
                                        <div class="col-sm-5">
                                            <select cls="{required:true}" class="form-control" name="payeeAcctAttr" >
                                           		<option value="yt_withdraw" label="网关" ${data.payeeAcctAttr.equals('yt_withdraw')?"selected":""} />
                                           		<option value="ytyl_withdraw" label="银联在线" ${data.payeeAcctAttr.equals('ytyl_withdraw')?"selected":""} />
                                            </select>
                                        </div>
                                        <div class="col-sm-5 form-control-static"></div>
                                    </div>
