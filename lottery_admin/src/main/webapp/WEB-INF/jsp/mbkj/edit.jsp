            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form role="form" class="form-horizontal" id="form" data-url="mbkj/editSubmit">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">代理商号：</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">代理商私钥：</label>
                                        <div class="col-sm-5">
                                            <input cls="{required:true}" type="text" name="payeeAcctAttr" class="form-control" value="${data.payeeAcctAttr}">
                                        </div>
                                        <div class="col-sm-5 form-control-static"></div>
                                    </div>
                                    <div class="form-group">
