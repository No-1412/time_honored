...
<c:if test="${data != null && data.items != null}">
	<c:forEach var="access" items="${data.items}">
	    <tr>
	        ...
	        <td>
	         	<a class="btn btn-sm btn-info edit_link" data-id="${access.id}" data-width="370px" data-height="400px" data-url="system/blanklist/edit" href="">编辑</a>
	         	<a class="btn btn-sm btn-danger cancel_link" data-id="${access.id}" data-url="system/blanklist/delete" href="">删除</a>
	        </td>
	    </tr>
    </c:forEach>
</c:if>
