...
@Controller
public class LotteryPlayJiSuSixController extends AdminBaseController {
	@Autowired
	...
	@RequestMapping(value="/system/lotteryPlayJiSuSix/index", method=RequestMethod.GET)
	public ModelAndView toIndex() throws Exception {
		Map<String, Object> dataMap = new HashMap<String, Object>();
		
		return createSuccessModelAndView("lotteryPlayJiSuSix/table", dataMap);
	}
	
	@RequestMapping(value="/system/lotteryPlayJiSuSix/getList", method=RequestMethod.GET)
	public ModelAndView getList(Integer page, Integer num) throws Exception {
		...
		List<LotteryPlayForm> playList = lotteryPlayService.getLotteryBigPlay(LotteryTypeService.JSLHC);
		...
		return createSuccessModelAndView("lotteryPlayJiSuSix/page", playPage);
	}
	
	@RequestMapping(value="/system/lotteryPlayJiSuSix/edit", method=RequestMethod.GET)
	public ModelAndView toEdit(String id) throws Exception {
		...
		setPlayDetailBonus(resultMap, LotteryTypeService.JSLHC, 0L, playNum1, playNum2);
		...
		return createSuccessModelAndView("lotteryPlayJiSuSix/dtl/" + getViewName(playNum1, playNum2), resultMap);
	}
	
	@ResponseBody
	@RequestMapping(value="/system/lotteryPlayJiSuSix/editSubmit", method=RequestMethod.POST)
	public CustomResponse editSubmit(String reward, Integer playNum1, Integer playNum2) throws Exception {
		Long roomId = 0L;
		Integer lotteryType = LotteryTypeService.JSLHC;
	...
	@ResponseBody
	@RequestMapping(value="/system/lotteryPlayJiSuSix/updateCache", method=RequestMethod.POST)
	public CustomResponse updateCache() throws Exception {
		lotteryPlayService.updateLotteryPlayCache(LotteryTypeService.JSLHC);
		return createSuccessJsonResponse(null);
	}
	
	@ResponseBody
	@RequestMapping(value="/system/lotteryPlayJiSuSix/updateAnimalsCache", method=RequestMethod.POST)
	public CustomResponse updateAnimalsCache() throws Exception {
		lotteryPlayService.updateAnimalsCache(LotteryTypeService.JSLHC);
		return createSuccessJsonResponse(null);
	}
